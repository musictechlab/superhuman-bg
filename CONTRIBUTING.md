...
1. Check existing [issues](https://github.com/musictechlab/superhuman-bg/issues)
   to avoid duplicates
...
Open a [discussion](https://github.com/musictechlab/superhuman-bg/discussions)
